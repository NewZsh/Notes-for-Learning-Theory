...
<div align=center>
<img src=http://latex.codecogs.com/gif.latex?\mathbb{P}(L_{\mathcal{D},f}(h_S)%3E\epsilon)\leq(1-p(z^*))^m\leq(1-\epsilon)^m\leq\delta\Rightarrowm\geq\ceil{\frac{\ln(1/\delta)}{1-\epsilon}}>
</div align=center>
