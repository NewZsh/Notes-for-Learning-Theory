...
*proof*: Let $\mathcal{H}_B$ be the set of 'bad' hypothesis, that is, $\mathcal{H}_B \subset \mathcal{H}$, and $\forall h\in\mathcal{H}_B$, such that $L_{\mathcal{D}, f}(h^*)>\epsilon$.
