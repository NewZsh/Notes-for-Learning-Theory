...
<div align=center>
<img src=http://latex.codecogs.com/gif.latex?\mathbb{P}(\theta\geq\frac{1}{8})%3D\Int_\frac{1}{8}^1\theta%20p(\theta)\rm{d}\theta%20\mathbb{E}(\theta)-\Int_0^\frac{1}{8}\theta%20p(\theta)\rm{d}\theta\leq\mathbb{E}(\theta)-\frac{1}{8}\>
</div align=center>
